...
class Ui_MainWindow(object):
    ...
    def menu(self,action):
        ...
        if txt=='NEW Team':
            ...
            self.list1.clear()
            self.list2.clear()
            self.t7.setText("Enter Team Name Here")
            #self.dial()
            text1,ok= QtWidgets.QInputDialog.getText(None, "Team", "Enter name of team:")
            #self.showdlg("Enter Team Name!")
            #print("oo")
            if ok:
                self.t7.setText(str(text1))
            #print("Ok2")
            self.show()
            #print("ok3")
    ...
    def openteam(self):
        ...
        team, ok=QtWidgets.QInputDialog.getItem(None,"Dream","Choose A Team",teams,0,False)
        if ok and team:
